# ========================= FINAL STABLE VERSION (All Models Fixed) =========================
import os
import json
import torch
...
model_name = st.selectbox("Select Model", ["MobileNetV1","GoogLeNet","ResNet101","EfficientNet-B0","VGG-16","ViT"])
