...
# =========================================================
MODEL_FILES = {
    "MobileNetV1": {"file_id": "1FqpeWNvrSHZk0o0Cka2o_BIXyjPgosMi", "path": "MobileNet-V1_imagenet100.pth"},
    "GoogLeNet": {"file_id": "1SrBz2SQ1VcyEItV-pX6HozJzKkHtJ2AR", "path": "googlenet_imagenet100.pth"},
    "ResNet101": {"file_id": "1RnSGWxh99VG3kb_LN-cx7rp1VWmEFEWs", "path": "Resnet-101_imagenet100.pth"}
}
...
class GoogLeNetRobust(nn.Module):
    def __init__(self, num_classes=100, pretrained=False, use_aux=True, device=None):
        ...
        self.model = models.googlenet(weights=None if not pretrained else models.GoogLeNet_Weights.DEFAULT,
                                     aux_logits=use_aux)
...
# 選擇輸入方式
# =========================================================
mode = st.radio("選擇輸入方式", ["上傳照片", "本地攝像頭"])
images = []
...
# --------- 本地攝像頭 ---------
    ...
    st.info("僅本地運行可使用攝像頭（瀏覽器會跳出授權提示）")
    start_cam = st.button("啟動攝像頭")
    if start_cam:
